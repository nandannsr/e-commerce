...
def cart(request,total=0, quantity=0, cart_items=None, reduction=0):
    ...
    try:
      ...
      if request.user.is_authenticated:
        ...
        if "coupon_code" in request.session: # coupon management in cart
...
def checkout(request,total=0, quantity=0, cart_items=None, reduction=0):
    ...
    try:
        ...
        for cart_item in cart_items:
            if cart_item.product.offer_price == 0:# checking offer price in the database
                total += cart_item.product.price * cart_item.quantity
            else:
                total += cart_item.product.offer_price * cart_item.quantity
